	...
	public sealed class KitchenCutscenePlayer : MonoBehaviour {
		...
		void Play() {
			...
			DOTween.Sequence()
				...
				.AppendCallback(() => AudioService.PlayInPool(this, StepsClip, true))
				...
				.Join(DOTween.To(() => AudioService.GetVolumeInPool(this), x => AudioService.SetVolumeInPool(this, x), 0f, 0.2f))
				.AppendInterval(PlayTime)
